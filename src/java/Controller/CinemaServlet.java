...
public class CinemaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("cinemas", dao.getAllCinemas());

        request.getRequestDispatcher("cinemaList.jsp").forward(request, response);
    }
    ...
    response.sendRedirect("CinemaServlet");
    }
